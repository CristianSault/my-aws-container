...
# __generated__ by Terraform from "us-east-1_XEQO4sVpp/4q2ob774dgjg96ji8j1g724d4k"
...
# __generated__ by Terraform from "us-east-1_XEQO4sVpp"
resource "aws_cognito_user_pool" "xpix" {
  alias_attributes           = null
  auto_verified_attributes   = ["email"]
  deletion_protection        = "ACTIVE"
  mfa_configuration          = "OFF"
  name                       = "User pool - ldkkh2"
  region                     = "us-east-1"
